...
fixture `4 - Getting Started Sauce demo`
...
fixture `4 - Getting Started Sauce demo - Bis`
	.page `https://www.saucedemo.com/`;
...
test(`SwagLabs standard user login - Err`, async function (t) {
	await t
		.typeText(login.usernameEl, Users.standard)
		.typeText(login.passwordEl, Users.password)
		.click('.btn_action')
		// Use the assertion to check if the actual header text is equal to the expected one
		.expect(Selector('#inventory_container').visible).eql(false);
});